...
## First, set up a new-to-this-assignment conda environment. 
#To the Canvas assignment, you should submit:
...
def nameofmoviefromapi (nameofmoviehereoneword):
...
##DO NOT FORGET TO UPLOAD IT TO GIT AND UPLOAD IT TO REPOSITORY!!!!!!!
